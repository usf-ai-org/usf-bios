...
from usf_bios.tuners import usf_to_peft_format
...
class USFExport(USFPipeline):
    ...
    def run(self):
        ...
        if args.to_peft_format:
            args.adapters[0] = usf_to_peft_format(args.adapters[0], args.output_dir)
        if args.merge_lora:
        ...
        if args.quant_method:
            ...
            from usf_bios.megatron import convert_mcore2hf
            convert_mcore2hf(args)
        elif args.to_mcore:
            from usf_bios.megatron import convert_hf2mcore
