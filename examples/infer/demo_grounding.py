...
def infer_grounding():
    ...
    from usf_bios import (TransformersEngine, RequestConfig, BaseArguments, InferRequest, safe_snapshot_download)
    output_path = 'bbox.png'
    image = load_image('https://placehold.co/400x300/png?text=animal')
    ...
    adapter_path = safe_snapshot_download('usf_bios/test_grounding')
...
if __name__ == '__main__':
    from usf_bios.template import draw_bbox, load_image
    infer_grounding()
