...
from usf_bios.template import Template, TemplateMeta
from usf_bios.utils import get_device, get_dist_setting, get_logger, is_dist
...
class VllmEngine(InferEngine):
    ...
    def __init__(
        ...
        *,
        ...
        if max_model_len is not None:
            ...
            logger.info_debug(f'Setting max_model_len: {max_model_len}')
    ...
    def _prepare_reasoning_parser(self, reasoning_parser: Optional[str]) -> None:
        ...
        logger.info_debug(f'Using reasoning_parser: {reasoning_parser}')
    ...
    def _prepare_generation_config(self, request_config: RequestConfig) -> SamplingParams:
        ...
        # Convert USF's Chat Completions API style (logprobs: bool, top_logprobs: int)
