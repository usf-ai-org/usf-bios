...
if TYPE_CHECKING:
    from usf_bios.model import ModelInfo, ModelMeta
...
def get_template(
    ...
    *,
    ...
    Args:
        ...
        template_backend (Literal['usf_bios', 'jinja'], optional): Template rendering engine:
            - 'usf_bios': USF BIOS's native template engine with advanced features
            - 'jinja': Jinja2 template engine
            Defaults to 'usf_bios'.
