...
def test_engine():
    from usf_bios.infer_engine import SglangEngine, RequestConfig
    from usf_bios.dataset import load_dataset
    dataset = load_dataset('tatsu-lab/alpaca#20')[0]
...
def test_engine_stream():
    from usf_bios.infer_engine import SglangEngine, RequestConfig
    from usf_bios.dataset import load_dataset
    dataset = load_dataset('tatsu-lab/alpaca#1')[0]
    engine = SglangEngine('Qwen/Qwen2.5-0.5B-Instruct')
