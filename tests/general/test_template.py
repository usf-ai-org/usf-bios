from usf_bios.dataset import EncodePreprocessor, load_dataset
from usf_bios.model import get_processor
from usf_bios.template import TemplateInputs, get_template
...
def test_llm_dataset_map():
    _test_dataset_map('Qwen/Qwen2-7B-Instruct', 'tatsu-lab/alpaca')


def test_mllm_dataset_map():
    _test_dataset_map('Qwen/Qwen2-VL-7B-Instruct', 'detection-datasets/coco:validation#100')
