...
def _infer_image_pipeline(model, images=None, prefix='<IMAGE_TOKEN>\n'):
    ...
    image = load_image('https://huggingface.co/datasets/usf-bios/test-assets/resolve/main/cat.png')
...
if __name__ == '__main__':
    from usf_bios.infer_engine import LmdeployEngine, InferRequest, RequestConfig
    # test_internvl2()
    # test_internvl2_5()
    # test_deepseek_vl()
    # test_qwen_vl()
