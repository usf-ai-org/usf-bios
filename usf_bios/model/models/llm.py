...
from usf_bios.utils import Processor, get_logger, safe_snapshot_download
...
class GrokLoader(ModelLoader):
    ...
    def get_processor(self, model_dir: str, config: PretrainedConfig) -> Processor:
        tokenizer_dir = safe_snapshot_download('grok-1-tokenizer', download_model=False, check_local=True)
...
register_model(
    ModelMeta(
        LLMModelType.dbrx, [
            ModelGroup([
                Model('dbrx-base', 'databricks/dbrx-base'),
                Model('dbrx-instruct', 'databricks/dbrx-instruct'),
            ]),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('c4ai-command-r-v01', 'CohereForAI/c4ai-command-r-v01'),
                Model('c4ai-command-r-plus', 'CohereForAI/c4ai-command-r-plus'),
            ]),
        ],
...
register_model(
    ModelMeta(
        LLMModelType.aya, [
            ModelGroup([
                Model('aya-expanse-8b', 'CohereForAI/aya-expanse-8b'),
                Model('aya-expanse-32b', 'CohereForAI/aya-expanse-32b'),
            ]),
        ],
