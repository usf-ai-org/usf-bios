...
**Note** The multi-turn training logic was refactored in usf-bios 3.8.
If your usf-bios version is earlier than 3.8, please consult the documentation for that version.
...
Specify the scheduler via `multi_turn_scheduler` in the `usf rollout` command:
...
> With the `external_plugins` argument you can register your own local scheduler with usf-bios.
> Refer to the [plugin code](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/plugin/plugin.py).

A full multi-turn training script can be found [here](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/external/vllm_multi_turn.sh).
...
See the implementation in [multi_turn.py](https://github.com/us-inc/usf-bios/blob/main/usf/plugins/multi_turn.py).
...
For a concrete implementation, see the [MultiTurnThinkingTips class](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/plugin/plugin.py)
...
For details, see [DeepEyes Scheduler](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/plugin/deepeyes/deepeyes_plugin.py#L403-L404).
...
For a concrete implementation, refer to the [ThinkingModelTipsScheduler class](https://github.com/us-inc/usf-bios/blob/main/usf/plugins/multi_turn.py)
...
usf-bios provides the `loss_scale` parameter to scale or mask parts of the response.
...
For how to return response_loss_mask, see the [ToolCallScheduler class](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/plugin/plugin.py)
...
USF BIOS >= 3.11 supports returning rollout logprobs from the vLLM side to address training-inference mismatch issues. For details, please refer to this [document](../AdvancedResearch/training_inference_mismatch.md).
...
For implementation, please refer to [here](https://github.com/us-inc/usf-bios/blob/main/usf/plugins/multi_turn.py)
