...
def export_to_ollama(args: ExportArguments):
    ...
    logger.info_debug(f'Using model_dir: {engine.model_dir}')
    ...
    logger.info_debug('Save Modelfile done, you can start ollama by:')
    logger.info_debug('> ollama serve')
    logger.info_debug('In another terminal:')
    logger.info_debug('> ollama create my-custom-model ' f'-f {os.path.join(args.output_dir, "Modelfile")}')
    logger.info_debug('> ollama run my-custom-model')
