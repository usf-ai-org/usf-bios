...
from usf_bios.utils import HfConfigFactory, get_logger, to_device, to_float_dtype
        ...
        if mm_type == 'image':
            ...
            data = {
                'messages': [{
                    ...
                    'role': 'assistant',
                    'content': "The audio contains a male voice speaking the phrase 'The weather is really nice today' in Mandarin."
                }],
                'audios': ['https://placehold.co/audio.wav']
            }
    else:
        data = {
            'messages': [
                {
                    'role': 'user',
                    'content': 'Introduction to usf-bios.'
                },
                {
                    'role':
                    'assistant',
                    'content':
                    'usf-bios is an official framework provided by the US Inc community for fine-tuning '
