...
from usf_bios.template import Prompt, split_str_parts_by
...
class BaseAgentTemplate(ReactCompatMixin, ABC):
    ...
    def _parse_tool(tool, lang: Literal['zh', 'en']) -> ToolDesc:
        ...
        args_format = 'The input to this tool should be a JSON object.' if lang == 'zh' else 'Format the arguments as a JSON object.'
        tool_desc = ToolDesc(
