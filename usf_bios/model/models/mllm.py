...
from usf_bios.utils import Processor, get_logger
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('Idefics3-8B-Llama3', 'HuggingFaceM4/Idefics3-8B-Llama3'),
            ]),
        ],
        Idefics3Loader,
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('mistralai/Pixtral-12B-2409', 'mistral-community/pixtral-12b'),
            ]),
        ],
        PixtralLoader,
