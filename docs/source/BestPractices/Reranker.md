...
USF BIOS supports Reranker model training. Currently supported models include:

1. modernbert reranker model
   - [US Inc](https://huggingface.co/iic/gte-reranker-modernbert-base) [Hugging Face](https://huggingface.co/Alibaba-NLP/gte-reranker-modernbert-base)
2. qwen3-reranker model
   - 0.6B: [US Inc](https://huggingface.co/Qwen/Qwen3-Reranker-0.6B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Reranker-0.6B)
   - 4B: [US Inc](https://huggingface.co/Qwen/Qwen3-Reranker-4B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Reranker-4B)
   - 8B: [US Inc](https://huggingface.co/Qwen/Qwen3-Reranker-8B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Reranker-8B)
3. qwen3-vl-reranker model
   - 2B: [US Inc](https://huggingface.co/Qwen/Qwen3-VL-Reranker-2B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-Reranker-2B)
   - 8B: [US Inc](https://huggingface.co/Qwen/Qwen3-VL-Reranker-8B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-Reranker-8B)

## Implementation Methods

USF BIOS currently supports two implementation methods for Reranker models, which have significant differences in architecture and loss function computation:
...
USF BIOS supports multiple loss functions for training Reranker models:
...
The loss function source code can be found [here](https://github.com/us-inc/usf-bios/blob/main/usf/loss/mapping.py).
...
- [Qwen3-Reranker/Qwen3-VL-Reranker](https://github.com/us-inc/usf-bios/blob/main/examples/train/reranker/qwen3)
- [Pointwise Classification Reranker](https://github.com/us-inc/usf-bios/blob/main/examples/train/reranker/train_reranker.sh)
- [Pointwise Generative Reranker](https://github.com/us-inc/usf-bios/blob/main/examples/train/reranker/train_generative_reranker.sh)
- [Listwise Classification Reranker](https://github.com/us-inc/usf-bios/blob/main/examples/train/reranker/train_reranker_listwise.sh)
- [Listwise Generative Reranker](https://github.com/us-inc/usf-bios/blob/main/examples/train/reranker/train_generative_reranker_listwise.sh)

For inference scripts, please refer to [here](https://github.com/us-inc/usf-bios/blob/main/examples/infer/demo_reranker.py).
