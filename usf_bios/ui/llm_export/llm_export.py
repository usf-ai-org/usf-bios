...
from usf_bios.utils import get_device_count
...
class LLMExport(BaseUI):
    ...
    def export(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}{additional_param}start /b usf export {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} {additional_param} nohup usf export {params} > {log_file} 2>&1 &'
