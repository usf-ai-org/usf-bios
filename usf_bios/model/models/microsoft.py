...
from usf_bios.utils import Processor, get_device, get_env_args
...
register_model(
    ModelMeta(
        ...
        [
            # llama2
            ModelGroup([
                Model('microsoft/Florence-2-base-ft', 'microsoft/Florence-2-base-ft'),
                Model('Florence-2-base', 'microsoft/Florence-2-base'),
                Model('Florence-2-large', 'microsoft/Florence-2-large'),
                Model('Florence-2-large-ft', 'microsoft/Florence-2-large-ft'),
            ]),
        ],
        FlorenceLoader,
