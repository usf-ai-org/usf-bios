...
from usf_bios.utils import Processor, get_device_count, get_dist_setting, get_logger, safe_snapshot_download
...
class CogVLMLoader(ModelLoader):
    ...
    def get_processor(self, model_dir: str, config: PretrainedConfig) -> Processor:
        tokenizer_dir = safe_snapshot_download('vicuna-7b-v1.5', download_model=False, check_local=True)
