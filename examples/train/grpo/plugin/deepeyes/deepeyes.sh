# 8 * 80G
# docs: https://usf-bios.readthedocs.io/en/latest/Instruction/GRPO/AdvancedResearch/deepeyes.html
...
# Second: Run usf rollout to deploy rollout server
# MAX_PIXELS=602112 \
...
# Third: Run usf rlhf to train GRPO model
MAX_PIXELS=602112 \
