...
from usf_bios.utils import Processor, get_logger, git_clone_github
...
class YiVLLoader(ModelLoader):
    ...
    def get_model(self, model_dir: str, config, processor, **kwargs) -> PreTrainedModel:
        ...
        logger.info_debug('Please ignore the above warning.')
        logger.info_debug('Loading the parameters of vision_tower...')
...
register_model(
    ModelMeta(
        ...
        [  # yi
            ...
            # yi1.5-quant
            ModelGroup([
                Model('Yi-1.5-6B-Chat-GPTQ', 'modelscope/Yi-1.5-6B-Chat-GPTQ'),
                Model('Yi-1.5-6B-Chat-AWQ', 'modelscope/Yi-1.5-6B-Chat-AWQ'),
                Model('Yi-1.5-9B-Chat-GPTQ', 'modelscope/Yi-1.5-9B-Chat-GPTQ'),
                Model('Yi-1.5-9B-Chat-AWQ', 'modelscope/Yi-1.5-9B-Chat-AWQ'),
                Model('Yi-1.5-34B-Chat-GPTQ', 'modelscope/Yi-1.5-34B-Chat-GPTQ'),
                Model('Yi-1.5-34B-Chat-AWQ', 'modelscope/Yi-1.5-34B-Chat-AWQ'),
            ], TemplateType.chatml),
            ModelGroup([
