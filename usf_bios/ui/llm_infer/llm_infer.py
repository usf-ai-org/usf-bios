...
class LLMInfer(BaseUI):
    ...
    def deploy(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}start /b usf deploy {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} nohup usf deploy {params} > {log_file} 2>&1 &'
    ...
    def deploy_model(cls, *args):
        ...
        logger.info_debug(f'Running deployment command: {run_command}')
