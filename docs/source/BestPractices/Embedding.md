...
USF BIOS has already supported the training of embedding models, including both pure text and multimodal types. Currently supported models include:

1. modernbert embedding model
   - [US Inc](https://huggingface.co/iic/gte-modernbert-base) [Hugging Face](https://huggingface.co/Alibaba-NLP/gte-modernbert-base)
2. gte embedding models
   - 1.5B: [US Inc](https://huggingface.co/iic/gte_Qwen2-1.5B-instruct) [Hugging Face](https://huggingface.co/Alibaba-NLP/gte-Qwen2-1.5B-instruct)
   - 7B: [US Inc](https://huggingface.co/iic/gte_Qwen2-7B-instruct) [Hugging Face](https://huggingface.co/Alibaba-NLP/gte-Qwen2-7B-instruct)
3. gme embedding models
   - 2B: [US Inc](https://huggingface.co/iic/gme-Qwen2-VL-2B-Instruct) [Hugging Face](https://huggingface.co/Alibaba-NLP/gme-Qwen2-VL-2B-Instruct)
   - 7B: [US Inc](https://huggingface.co/iic/gme-Qwen2-VL-7B-Instruct) [Hugging Face](https://huggingface.co/Alibaba-NLP/gme-Qwen2-VL-7B-Instruct)
4. qwen3-embedding models
   - 0.6B: [US Inc](https://huggingface.co/Qwen/Qwen3-Embedding-0.6B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Embedding-0.6B)
   - 4B: [US Inc](https://huggingface.co/Qwen/Qwen3-Embedding-4B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Embedding-4B)
   - 8B: [US Inc](https://huggingface.co/Qwen/Qwen3-Embedding-8B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-Embedding-8B)
5. qwen3-vl-embedding models
   - 2B: [US Inc](https://huggingface.co/Qwen/Qwen3-VL-Embedding-2B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-Embedding-2B)
   - 8B: [US Inc](https://huggingface.co/Qwen/Qwen3-VL-Embedding-8B) [Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-Embedding-8B)
...
It should be noted that the embedding models currently supported by USF BIOS are all based on pure text or multimodal LLMs, and CLIP-type model training is not currently supported.

Additionally, all embedding models supported by USF BIOS have normalization added at the end of the model forward pass. If you add new models yourself, please remember to include a normalization layer.

## Loss

The Embedding models supported by USF BIOS currently can use the following loss functions:
...
The source code for the loss functions can be found [here](https://github.com/us-inc/usf-bios/blob/main/usf/loss/mapping.py).
...
Training scripts provided by usf-bios:

- [Qwen3-Embedding/Qwen3-VL-Embedding model](https://github.com/us-inc/usf-bios/blob/main/examples/train/embedding/qwen3)
- [GME model](https://github.com/us-inc/usf-bios/blob/main/examples/train/embedding/train_gme.sh)

## Inference

USF BIOS has supported the deployment of GME, GTE, Qwen3-Embedding models, please check [here](https://github.com/us-inc/usf-bios/blob/main/examples/deploy/embedding/client.py).
- For inference scripts, please refer to [here](https://github.com/us-inc/usf-bios/blob/main/examples/infer/demo_embedding.py).

You can also use the original model's code for inference:

https://huggingface.co/iic/gte_Qwen2-7B-instruct

https://huggingface.co/iic/gme-Qwen2-VL-7B-Instruct
...
https://huggingface.co/iic/gme-Qwen2-VL-7B-Instruct/file/view/master/gme_inference.py?status=1#L111
