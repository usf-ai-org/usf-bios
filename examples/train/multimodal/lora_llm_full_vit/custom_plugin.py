...
from usf_bios.utils import deep_getattr, get_logger, get_multimodal_target_regex

logger = get_logger()
if TYPE_CHECKING:
    from usf_bios import SftArguments
...
class CustomTuner(Tuner):
    ...
    def from_pretrained(model: torch.nn.Module, model_id: str, **kwargs) -> torch.nn.Module:
        model = USF.from_pretrained(model, model_id, **kwargs)
