...
This document provides training scripts for various human preference alignment algorithms. If you want to learn more about the algorithms and how to choose them, please refer to the [documentation](https://github.com/us-inc/huggingface-classroom/blob/main/LLM-tutorial/M.%E4%BA%BA%E7%B1%BB%E5%81%8F%E5%A5%BD%E5%AF%B9%E9%BD%90%E8%AE%AD%E7%BB%83.md).
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/grpo).
...
- [DPO script](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/dpo)
- [MPO script](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/mpo.sh)
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/rm.sh).
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/kto.sh).
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/cpo.sh).
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/orpo.sh).
...
Reference the training script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/simpo.sh).
