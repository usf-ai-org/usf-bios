    ...
    ModelMeta(
        ...
        [
            ModelGroup([
                ...
                Model('InternVL-Chat-V1-5', 'OpenGVLab/InternVL-Chat-V1-5'),
                Model('InternVL-Chat-V1-5-int8', 'OpenGVLab/InternVL-Chat-V1-5-int8'),
            ], ),
        ],
        InternVLLoader,
        ...
        if self.version == 'v2-4khd':
            ...
            def load_model(self):
                self.vision_tower_name = safe_snapshot_download(
                    'clip-vit-large-patch14-336', check_local=True)
