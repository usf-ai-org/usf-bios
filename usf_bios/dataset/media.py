...
from usf_bios.utils import get_logger, safe_ddp_context
...
class MediaResource:
    ...
    def _safe_download(media_type: Union[str, List[str]],
        ...
        logger.info_debug('# #################Resource downloading#################')
        logger.info_debug('Downloading necessary resources...')
        logger.info_debug(f'Resource package: {media_type}')
        logger.info_debug(f'Extracting to local dir: {final_folder}')
        logger.info_debug('If the downloading fails or lasts a long time, '
                    'you can manually download the resources and extracting to the local dir.')
        logger.info_debug('Now begin.')
        ...
        logger.info_debug('# #################Resource downloading finished#################')
        return final_folder
