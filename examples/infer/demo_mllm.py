...
def get_message(mm_type: Literal['text', 'image', 'video', 'audio']):
    if mm_type == 'text':
            ...
            'content': [
                {
                    ...
                    'image': 'https://placehold.co/400x300/png?text=animal'
                },
                {
                    'type': 'text',
        ...
        message = {
            ...
            'content': [{
                'type': 'audio',
                'audio': 'https://placehold.co/audio.wav'
            }, {
                'type': 'text',
...
def get_data(mm_type: Literal['text', 'image', 'video', 'audio']):
    ...
    if mm_type == 'text':
        ...
        data['images'] = ['https://placehold.co/400x300/png?text=animal']
    elif mm_type == 'video':
        messages = [{'role': 'user', 'content': '<video>Describe this video.'}]
        data['videos'] = ['https://placehold.co/400x300/mp4?text=video']
    elif mm_type == 'audio':
        messages = [{'role': 'user', 'content': '<audio>What does this audio say?'}]
        data['audios'] = ['https://placehold.co/audio.wav']
...
if __name__ == '__main__':
    ...
    # https://github.com/us-inc/usf-bios/tree/main/examples/notebook
    from usf_bios import InferEngine, InferRequest, TransformersEngine, RequestConfig, load_dataset, InferStats
    ...
    if infer_backend == 'transformers':
        ...
        # https://usf-bios.readthedocs.io/zh-cn/latest/Instruction/%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%8F%82%E6%95%B0.html#id17
        from usf_bios.infer_engine import VllmEngine
        ...
        from usf_bios.infer_engine import LmdeployEngine
    ...
    if mm_type == 'audio':
        ...
        dataset = 'linxy/LaTeX_OCR:small#1000'
    elif mm_type == 'video':
        dataset = 'usf_bios/VideoChatGPT:Generic#100'
