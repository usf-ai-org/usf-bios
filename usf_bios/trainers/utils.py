...
from usf_bios.model import ModelMeta
from usf_bios.sequence_parallel import ChunkedCrossEntropyLoss, GatherLoss, sequence_parallel
from usf_bios.utils import deep_getattr, get_logger
...
def dynamic_gradient_checkpointing(model, including_vit: bool = False) -> None:
    ...
    for tower_name in tower_names:
        ...
        logger.info_debug(f'Automatically add gradient_checkpointing to {model_tower.__class__}.')
