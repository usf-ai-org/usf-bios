...
from usf_bios.megatron.arguments import MegatronRLHFArguments
from usf_bios.megatron.trainers import (MegatronDPOTrainer, MegatronGKDTrainer, MegatronGRPOTrainer, MegatronKTOTrainer,
                                     MegatronRewardTrainer)
from usf_bios.pipelines.train import prepare_kto_dataset
from usf_bios.rlhf_trainers.utils import identity_data_collator
from usf_bios.utils import get_current_device, get_logger, is_last_rank
...
class MegatronRLHF(MegatronSft):
    ...
    def prepare_trainer(self):
        ...
        if trainer_cls is None:
            raise ValueError(f'The current Megatron-USF BIOS does not support rlhf_type: {args.rlhf_type}.')
        kwargs = {}
    ...
    def _prepare_vllm_client(self):
        ...
        from usf_bios.rlhf_trainers.vllm_client import VLLMClient
        vllm_client = None
        if is_last_rank():
