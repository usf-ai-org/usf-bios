...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('paligemma-3b-pt-224', 'google/paligemma-3b-pt-224'),
                Model('paligemma-3b-pt-448', 'google/paligemma-3b-pt-448'),
                Model('paligemma-3b-pt-896', 'google/paligemma-3b-pt-896'),
            ]),
            ModelGroup([
                Model('google/paligemma-3b-mix-224', 'google/paligemma-3b-mix-224'),
                Model('paligemma-3b-mix-448', 'google/paligemma-3b-mix-448'),
            ]),
            ModelGroup([
                Model('paligemma2-3b-pt-224', 'google/paligemma2-3b-pt-224'),
                Model('paligemma2-3b-pt-448', 'google/paligemma2-3b-pt-448'),
                Model('paligemma2-3b-pt-896', 'google/paligemma2-3b-pt-896'),
                Model('paligemma2-10b-pt-224', 'google/paligemma2-10b-pt-224'),
                Model('paligemma2-10b-pt-448', 'google/paligemma2-10b-pt-448'),
                Model('paligemma2-10b-pt-896', 'google/paligemma2-10b-pt-896'),
                Model('paligemma2-28b-pt-224', 'google/paligemma2-28b-pt-224'),
                Model('paligemma2-28b-pt-448', 'google/paligemma2-28b-pt-448'),
                Model('paligemma2-28b-pt-896', 'google/paligemma2-28b-pt-896'),
            ]),
            ModelGroup([
                Model('google/paligemma2-3b-ft-docci-448', 'google/paligemma2-3b-ft-docci-448'),
                Model('paligemma2-10b-ft-docci-448', 'google/paligemma2-10b-ft-docci-448'),
            ]),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('gemma-2b-it', 'google/gemma-2b-it'),
                Model('gemma-2b', 'google/gemma-2b'),
                Model('gemma-7b', 'google/gemma-7b'),
                Model('gemma-7b-it', 'google/gemma-7b-it'),
            ], ),
        ],
