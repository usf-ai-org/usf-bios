...
from usf_bios.megatron.arguments import MegatronSftArguments
from usf_bios.megatron.trainers import MegatronTrainer
from usf_bios.megatron.utils import get_padding_to
from usf_bios.pipelines import USFSft
from usf_bios.template import TEMPLATE_MAPPING
from usf_bios.utils import get_logger, is_last_rank, plot_images
...
class MegatronSft(USFSft):
    ...
    def _get_data_collator(self):
        ...
        logger.info_debug(f'padding_to: {padding_to}')
