...
from usf_bios.utils import get_device, git_clone_github
    ...
    ModelMeta(
        ...
        [
            ...
            ModelGroup(
                [
                    # base
                    Model('chinese-llama-2-1.3b', 'hfl/chinese-llama-2-1.3b'),
                    Model('chinese-llama-2-7b', 'hfl/chinese-llama-2-7b'),
                    Model('chinese-llama-2-7b-16k', 'hfl/chinese-llama-2-7b-16k'),
                    Model('chinese-llama-2-7b-64k', 'hfl/chinese-llama-2-7b-64k'),
                    Model('chinese-llama-2-13b', 'hfl/chinese-llama-2-13b'),
                    Model('chinese-llama-2-13b-16k', 'hfl/chinese-llama-2-13b-16k'),
                    # chat
                    Model('chinese-alpaca-2-1.3b', 'hfl/chinese-alpaca-2-1.3b'),
                    Model('chinese-alpaca-2-7b', 'hfl/chinese-alpaca-2-7b'),
                    Model('chinese-alpaca-2-7b-16k', 'hfl/chinese-alpaca-2-7b-16k'),
                    Model('chinese-alpaca-2-7b-64k', 'hfl/chinese-alpaca-2-7b-64k'),
                    Model('chinese-alpaca-2-13b', 'hfl/chinese-alpaca-2-13b'),
                    Model('chinese-alpaca-2-13b-16k', 'hfl/chinese-alpaca-2-13b-16k'),
                ],
                TemplateType.llama),
            # base quant
            ModelGroup([
                Model('Llama-2-7b-AQLM-2Bit-1x16-hf', 'ISTA-DASLab/Llama-2-7b-AQLM-2Bit-1x16-hf'),
            ],
                       TemplateType.llama,
            ...
            ModelGroup([
                Model('NuminaMath-7B-TIR', 'AI-MO/NuminaMath-7B-TIR'),
            ],
            ...
            # llama3-quant
            ModelGroup([
                Model('usf_bios/Meta-Llama-3-8B-Instruct-GPTQ-Int4', 'study-hjt/Meta-Llama-3-8B-Instruct-GPTQ-Int4'),
                Model('usf_bios/Meta-Llama-3-8B-Instruct-GPTQ-Int8', 'study-hjt/Meta-Llama-3-8B-Instruct-GPTQ-Int8'),
                Model('usf_bios/Meta-Llama-3-8B-Instruct-AWQ', 'study-hjt/Meta-Llama-3-8B-Instruct-AWQ'),
                Model('usf_bios/Meta-Llama-3-70B-Instruct-GPTQ-Int4', 'study-hjt/Meta-Llama-3-70B-Instruct-GPTQ-Int4'),
                Model('usf_bios/Meta-Llama-3-70B-Instruct-GPTQ-Int8', 'study-hjt/Meta-Llama-3-70B-Instruct-GPTQ-Int8'),
                Model('usf_bios/Meta-Llama-3-70B-Instruct-AWQ', 'study-hjt/Meta-Llama-3-70B-Instruct-AWQ'),
            ], TemplateType.llama3),
            # chinese-llama3
            ModelGroup([
            ...
            # nvidia Nemotron
            ModelGroup([
                Model('nvidia/Llama-3.1-Nemotron-70B-Instruct-HF', 'nvidia/Llama-3.1-Nemotron-70B-Instruct-HF'),
            ],
                       TemplateType.llama3_2,
                       requires=['transformers>=4.43']),
            ModelGroup([
                Model('Skywork/Skywork-o1-Open-Llama-3.1-8B', 'Skywork/Skywork-o1-Open-Llama-3.1-8B'),
            ],
