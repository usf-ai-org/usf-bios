...
Training script reference [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/rlhf/gkd/vllm_server.sh), for related parameters, please refer to [GRPO vLLM Parameters](./Command-line-parameters.md#vllm_mode).
...
Training script reference [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/multimodal/rlhf/gkd/fast.sh)
...
For a complete implementation, refer to the example script [here](https://github.com/us-inc/usf-bios/tree/main/examples/train/on_policy_distillation.sh).
