...
**Version Requirement**: usf-bios>=3.8
...
For training, you can refer to [this script](https://github.com/us-inc/usf-bios/blob/main/examples/train/grpo/internal/gspo.sh).
