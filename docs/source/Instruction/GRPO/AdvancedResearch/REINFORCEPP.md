...
**Version requirement**: usf-bios>=3.10
...
For training examples, please refer to this [script](https://github.com/us-inc/usf-bios/tree/main/examples/train/grpo/internal/reinforce_plus_plus.sh)
