...
For information on the design and use of custom rewards, you can refer to the implementation of [DeepEyes](https://github.com/us-inc/usf-bios/tree/main/examples/train/grpo/plugin/deepeyes/deepeyes_plugin.py).

The complete training script can be found at [script](https://github.com/us-inc/usf-bios/tree/main/examples/train/grpo/plugin/treepo/tree_rollout.sh).
