...
from usf_bios.utils import find_free_port, get_device_count, get_logger, safe_snapshot_download
...
class DeployArguments(InferArguments):
    ...
    Args:
        ...
        owned_by (str): The owner of the deployment. Defaults to 'usf_bios'.
        ...
        verbose (bool): Whether to log detailed request information. Defaults to True.
            Note: This defaults to False when used in 'usf app' or 'usf eval'.
...
class RolloutArguments(DeployArguments):
    ...
    Args:
        multi_turn_scheduler (Optional[str]): The scheduler for multi-turn GRPO training. Pass the name of the
            corresponding plugin implemented in `usf_bios/plugins/multi_turn.py`. Defaults to None. Refer to the
    ...
    # only for GRPO rollout with AsyncEngine, see details in usf_bios/plugins/multi_turn
