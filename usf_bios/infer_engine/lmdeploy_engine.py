...
from usf_bios.utils import is_debug_mode, get_logger, get_seed
...
class LmdeployEngine(InferEngine):
    ...
    def _prepare_engine_kwargs(self, engine_kwargs):
        ...
        if is_debug_mode():
            logger.info_debug(f'backend_config: {backend_config}')
        ...
        if is_multimodal:
            ...
            if is_debug_mode():
                logger.info_debug(f'vision_config: {vision_config}')
