...
from usf_bios.trainers.arguments import USFArgumentsMixin
from .args_mixin import GRPOArgumentsMixin, RolloutTrainerArgumentsMixin


@dataclass
class DPOConfig(USFArgumentsMixin, HfDPOConfig):
    ld_alpha: Optional[float] = None  # compat trl==0.15


@dataclass
class CPOConfig(USFArgumentsMixin, HfCPOConfig):
    pass


@dataclass
class ORPOConfig(USFArgumentsMixin, HfORPOConfig):
    pass


@dataclass
class KTOConfig(USFArgumentsMixin, HfKTOConfig):
    pass


@dataclass
class RewardConfig(USFArgumentsMixin, HfRewardConfig):
    pass


@dataclass
class PPOConfig(USFArgumentsMixin, HfPPOConfig):
    pass


@dataclass
class GKDConfig(RolloutTrainerArgumentsMixin, USFArgumentsMixin, HfGKDConfig):
    ...
    def __post_init__(self):
        ...
        USFArgumentsMixin.__post_init__(self)


@dataclass
class GRPOConfig(GRPOArgumentsMixin, USFArgumentsMixin, HfGRPOConfig):
    ...
    def __post_init__(self):
        ...
        if self.deepspeed and 'zero_optimization' in self.deepspeed and self.deepspeed['zero_optimization'][
                'stage'] == 3:
            # https://github.com/us-inc/usf-bios/issues/3237
        ...
        # https://github.com/us-inc/usf-bios/issues/3863
