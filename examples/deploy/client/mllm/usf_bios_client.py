...
def run_client(host: str = '127.0.0.1', port: int = 8000):
    ...
    dataset = load_dataset(['linxy/LaTeX_OCR:small#1000'], seed=42)[0]
...
if __name__ == '__main__':
    from usf_bios import (InferEngine, InferRequest, InferClient, RequestConfig, load_dataset, run_deploy, DeployArguments,
                       InferStats)
