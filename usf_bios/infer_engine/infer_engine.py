...
from usf_bios.model import get_ckpt_dir
from usf_bios.template import Template, get_template
from usf_bios.utils import Processor, ProcessorMixin, get_logger
...
class InferEngine(BaseInferEngine, ProcessorMixin):
    ...
    def _get_template(self, processor: Processor):
        ...
        logger.info_debug('Create the template for the infer_engine')
        if ckpt_dir:
