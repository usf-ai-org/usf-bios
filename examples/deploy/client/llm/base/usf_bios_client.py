...
def run_client(host: str = '127.0.0.1', port: int = 8000):
    ...
    infer_requests = [InferRequest(messages=[{'role': 'user', 'content': ' -> \n -> \n ->'}])]
    infer_batch(engine, infer_requests)


if __name__ == '__main__':
    from usf_bios import run_deploy, DeployArguments, InferEngine, InferRequest, InferClient, RequestConfig
