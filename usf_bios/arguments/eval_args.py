...
from usf_bios.model import get_matched_model_meta
from usf_bios.utils import get_logger, json_parse_to_dict, to_abspath
...
class EvalArguments(DeployArguments):
    ...
    # If eval_url is set, usf-bios will not perform deployment operations and
    ...
    def __post_init__(self):
        ...
        logger.info_debug(f'eval_output_dir: {self.eval_output_dir}')
    ...
    def _init_eval_dataset(self):
        ...
        logger.info_debug(f'eval_backend: {self.eval_backend}')
        logger.info_debug(f'eval_dataset: {self.eval_dataset}')
