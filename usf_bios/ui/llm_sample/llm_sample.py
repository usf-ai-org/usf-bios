...
class LLMSample(BaseUI):
    ...
    def sample(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}start /b usf sample {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} nohup usf sample {params} > {log_file} 2>&1 &'
    ...
    def sample_model(cls, *args):
        ...
        logger.info_debug(f'Running sample command: {run_command}')
