    ...
    def _format_tools(self, tools: List[Union[str, dict]], system: Optional[str] = None, user_message=None) -> str:
        ...
        for tool in tools:
            ...
            tool_descs.append(f'## {name}\n\n{json.dumps(tool, ensure_ascii=False, indent=4)}\n'
                              'When calling the above functions, please use JSON format to represent the parameters.')
        glm4_system = 'You are an AI assistant named GLM-4. You are developed based on the GLM-4 language model trained by Zhipu AI. Your task is to provide appropriate responses and support for user questions and requests.\n\n'  # noqa
        return ('' if self.is_glm4_0414 else glm4_system) + """# Available Tools
