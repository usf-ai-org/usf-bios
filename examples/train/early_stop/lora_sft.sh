# 22GB
# Change: https://github.com/us-inc/usf-bios/blob/main/usf_bios/plugins/callback.py
...
#[INFO:usf] Saving model checkpoint to output/xxx/checkpoint-10
#[INFO:usf] Training stop because of eval metric is stable at step 10
