...
# demo_seq_cls: https://github.com/us-inc/usf-bios/blob/main/examples/train/seq_cls/qwen2_5_omni/infer.py
import os
...
if __name__ == '__main__':
 ...
 from usf_bios import (InferEngine, InferRequest, TransformersEngine, load_dataset, safe_snapshot_download,
 BaseArguments)
 from usf_bios.tuners import USF
 adapter_path = safe_snapshot_download('usf_bios/test_bert')
