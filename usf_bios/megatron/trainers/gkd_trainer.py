...
from usf_bios.megatron.arguments import MegatronArguments
from usf_bios.model import get_model_info_meta
...
from .utils import get_usf_datasets_provider, load_megatron_model_to_gpu, offload_megatron_model_to_cpu
...
class MegatronGKDTrainer(MegatronRolloutMixin, MegatronRLHFTrainer):
    ...
    def setup_model_and_optimizer(self, model_provider_func, model_type, *_args, **kwargs):
        ...
        """
        # Get teacher model path from USF args
        teacher_model_path = self.args.teacher_model
        logger.info_debug(f'Loading teacher model from: {teacher_model_path}')
    ...
    def _load_teacher_model(self, teacher_model_path: str, model_type: str):
        ...
        logger.info_debug(f'Loading teacher model: type={teacher_model_type}, '
        ...
        try:
            ...
            logger.info_debug(f'Teacher model loaded successfully with PP={megatron_args.pipeline_model_parallel_size}, '
        ...
        if self.offload_teacher_model:
            ...
            logger.info_debug('Teacher models offloaded to CPU to save GPU memory')
