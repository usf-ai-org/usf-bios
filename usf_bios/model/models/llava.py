...
from usf_bios.utils import git_clone_github, safe_snapshot_download
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('llava-llama-3-8b-v1_1-transformers', 'xtuner/llava-llama-3-8b-v1_1-transformers'),
            ]),
        ],
        LlavaLlamaHfLoader,
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('usf_bios/llava-llama3.1-8b'),
            ], ),
        ],
        LlavaNextHfLoader,
...
class LlavaLoader(ModelLoader):
    ...
    def get_model(self, model_dir: str, config, processor, model_kwargs) -> PreTrainedModel:
        ...
        config.mm_vision_tower = safe_snapshot_download('clip-vit-large-patch14-336', check_local=True)
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('llama3-llava-next-8b', 'lmms-lab/llama3-llava-next-8b'),
            ], ),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('llava-hf/llava-v1.6-mistral-7b-hf', 'liuhaotian/llava-v1.6-mistral-7b'),
            ], ),
        ],
        LlavaMistralLoader,
...
register_model(
    ModelMeta(
        MLLMModelType.llava1_6_yi, [
            ModelGroup([
                Model('llava-v1.6-34b', 'liuhaotian/llava-v1.6-34b'),
            ], ),
        ],
        LlavaLlamaLoader,
...
register_model(
    ModelMeta(
        MLLMModelType.llava_next_qwen, [
            ModelGroup([
                Model('llava-next-72b', 'lmms-lab/llava-next-72b'),
                Model('llava-next-110b', 'lmms-lab/llava-next-110b'),
            ], ),
        ],
        LlavaNextQwenLoader,
