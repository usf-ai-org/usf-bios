...
from usf_bios.utils import get_generative_reranker_logits, safe_snapshot_download, to_device
...
class TransformersEngine(InferEngine):
    ...
    def _add_adapter(self, adapter_path: str, adapter_name: Optional[str] = None) -> None:
        self.model = USF.from_pretrained(self.model, adapter_path, adapter_name)
