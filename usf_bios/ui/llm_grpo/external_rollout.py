...
class LLMRollout(BaseUI):
    ...
    def rollout(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}start /b usf rollout {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} nohup usf rollout {params} > {log_file} 2>&1 &'
    ...
    def rollout_model(cls, *args):
        ...
        logger.info_debug(f'Running rollout command: {run_command}')
