.. usf documentation file,
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

USF BIOS DOCUMENTATION
========================
...
.. toctree::
   ...
   GetStarted/USF BIOS-installation.md
...
.. toctree::
   :maxdepth: 2
   :caption: Megatron-USF BIOS

   Megatron-USF BIOS/Quick-start.md
   Megatron-USF BIOS/Command-line-parameters.md
   Megatron-USF BIOS/LoRA-Training.md
   Megatron-USF BIOS/Multimodal-Model.md
   Megatron-USF BIOS/Mcore-Bridge.md
   Megatron-USF BIOS/GRPO.md
   Megatron-USF BIOS/GKD.md
   Megatron-USF BIOS/Ascend.md
