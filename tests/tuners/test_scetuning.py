...
from usf_bios.tuners import SCETuningConfig, USF_BIOS
...
class TestSCETuning(unittest.TestCase):
    ...
    def test_scetuning_on_diffusers_v1(self):
        ...
        model = USF_BIOS.prepare_model(model, config=scetuning_config)
        ...
        model_check = USF_BIOS.from_pretrained(model_check, self.tmp_dir)
