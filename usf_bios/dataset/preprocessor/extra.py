...
class GroundingMixin:
    ...
    _grounding_prompts = {
        'grounding': {
            ...
            'zh': [('<ref-object>', '<bbox>'), ('<ref-object> location in the image', '<bbox>'), ('<ref-object> in the image', '<bbox>'),
                   ('<ref-object> at', '<bbox>'), ('Find<ref-object> location', '<bbox>'), ('<ref-object> at', '<bbox>'),
                   ('Provide<ref-object> coordinates', '<bbox>')]
        },
        'caption': {
            'en': [
                ('<bbox>', '<ref-object>'),
            ...
            'zh': [
                ('<bbox>', '<ref-object>'),
                ('<bbox> is what', '<ref-object>'),
                ('<bbox> location contains', '<ref-object>'),
                ('Describe<bbox>', '<ref-object>'),
                ('<bbox> contains', '<ref-object>'),
                ('Coordinates<bbox>Describe what', '<ref-object>'),
                ('Describe<bbox> the content of', '<ref-object>'),
            ]
        },
    }
